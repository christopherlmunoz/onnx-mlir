...
// CHECK:           [[VAR_20_:%.+]] = arith.addf [[VAR_19_]], [[VAR_3_]] : f32
// CHECK:           [[VAR_21_:%.+]] = arith.maxnumf [[VAR_20_]], [[CST_0_dot_000000_]] : f32
// CHECK:           [[VAR_22_:%.+]] = arith.minnumf [[VAR_21_]], [[CST_2_dot_550000_]] : f32
// CHECK:           [[VAR_23_:%.+]] = arith.fptoui [[VAR_22_]] : f32 to i32
// CHECK:           [[VAR_24_:%.+]] = arith.trunci [[VAR_23_]] : i32 to i8
// CHECK:           [[VAR_25_:%.+]] = builtin.unrealized_conversion_cast [[VAR_24_]] : i8 to ui8
// CHECK:           krnl.store [[VAR_25_]], [[RES_]][] : memref<ui8>
